...
<html>
    ...
    <body>
        ...
        <c:if test="${empty nueva}">
            <div id="div_patrocinadores" class="" style="height: 100px;padding:10px; border:5px 5px solid green">
                <div class="col-md-2">
                    <a onclick="tipo = 'idea_r'; $('#busqueda').val(''); busqueda_enter();" class="label label-primary thumbnail" style="width: 200px; cursor: pointer; border-radius: 25px;" title="Ideas registradas por emprendedores"> <span class="glyphicon glyphicon-pencil"></span>  <span class="badge"> <span style="font-size: 20;">406</span> </span>Ideas Registradas </a>
                    <a onclick="tipo = 'idea_v'; $('#busqueda').val(''); busqueda_enter();" class="label label-warning thumbnail" style="width: 200px; cursor: pointer; border-radius: 25px;" title="Ideas validadas por los evaluadores"> <span class="glyphicon glyphicon-ok"></span>  <span class="badge"> <span style="font-size: 20;">53</span> </span>Ideas Validadas </a>
                </div>
                <div class="col-md-2">
                    <a onclick="tipo = 'innovador'; $('#busqueda').val(''); busqueda_enter();" class="label label-info thumbnail" style="width: 200px; cursor: pointer; border-radius: 25px;" title="Personas que han registrado o participado en una idea de emprendimiento"> <span class="glyphicon glyphicon-user"></span>  <span class="badge"> <span style="font-size: 20;">484</span> </span>Innovadores </a>
                    <a onclick="tipo = 'evaluador'; $('#busqueda').val(''); busqueda_enter();" class="label label-success thumbnail" style="width: 200px; cursor: pointer; border-radius: 25px;" title="Personas que evalúan las ideas registradas"> <span class="glyphicon glyphicon-eye-open"></span>  <span class="badge"> <span style="font-size: 20;">30</span> </span>Evaluadores </a>
                </div>
                <div class="col-md-2">
                    <a onclick="tipo = 'convocatoria'; $('#busqueda').val(''); busqueda_enter('convocatoria');" class="label label-default thumbnail" style="width: 200px; cursor: pointer; border-radius: 25px;" title="Lista de convocatorias ofertadas"> <span class="glyphicon glyphicon-calendar"></span>  <span class="badge"> <span style="font-size: 20;">30</span> </span>Convocatorias </a>
                    <a onclick="tipo = 'patrocinador'; $('#busqueda').val(''); busqueda_enter();" class="label thumbnail" style="width: 200px; cursor: pointer; border-radius: 25px; color:black;" title="Personas que financiarán las ideas de emprendimiento"> <span class="glyphicon glyphicon-usd"></span>  <span class="badge"> <span style="font-size: 20;">0</span> </span>Patrocinadores </a>
                </div>
                <div class="col-md-6">
                    <p>
                    ...
                    <div class="center-block text-center" >
                        <img src="${pageContext.request.contextPath}/recursos/img/bi-utpl.png" style="height: 75px;" />
                    </div>
                </div>
            </div>
        </c:if>
        ...
        <c:if test="${empty nueva}">
            <div class="" style="width:99%;padding:0px 60px;">
                <input class="easyui-searchbox" data-options="prompt:'Búsqueda de resultdos...',menu:'#types',searcher:busqueda_enter" id="busqueda" name="busqueda" style="width:100%;" autofocus="autofocus">
        ...
        <div class="easyui-layout" style="height:800px;">
            <c:if test="${empty nueva}">
                <div data-options="region:'north', border:false" >
                    <div id="span_total">
                        ...
                        <div class="col-md-3">
                            <span style="padding:10px 60px;">Resultados encontrados:  <span class="badge" id="total"></span> </span>
                        </div>
                        <div class="col-md-3">
            ...
            <div data-options="region:'center',title:'Resultados',iconCls:'icon-ok'" style="height:1000px;">

                <div class="" id="results" style="padding: 5px;">
                    <c:if test="${nueva == 'true' && opcion == '1'}">
                        <form action="guardar.htm" modelAttribute="idea"  method="POST" enctype="multipart/form-data">
                                    ...
                                    <div>
                                        <small><small>
                                                <ul class="list-inline" >
                                                    <li>
                                                        <a data-toggle="tooltip" data-placement="top" title="Facebook" href="https://api.addthis.com/oexchange/0.8/forward/facebook/offer?url=http://apps.utpl.edu.ec/bancoideas&pubid=ra-56b133c326f46762&ct=1&title=Banco de Ideas: ${idea.nombre}" target="_blank">
                                                    ...
                                                    <li>
                                                        <a data-toggle="tooltip" data-placement="top" title="Twitter" href="https://api.addthis.com/oexchange/0.8/forward/twitter/offer?url=http://apps.utpl.edu.ec/bancoideas&ct=1&title=Banco de Ideas: ${idea.nombre}" target="_blank">
                                                            <span class="fa-stack fa-lg">
                                                                <i class="fa fa-circle fa-stack-2x"></i>
                                                    ...
                                                    <li>
                                                        <a data-toggle="tooltip" data-placement="top" title="LinkedIn" href="https://api.addthis.com/oexchange/0.8/forward/linkedin/offer?url=http://apps.utpl.edu.ec/bancoideas&pubid=ra-56b133c326f46762&ct=1&title=Banco de Ideas: ${idea.nombre}" target="_blank">
                                                            <span class="fa-stack fa-lg">
                                                                <i class="fa fa-circle fa-stack-2x"></i>
                                                    ...
                                                    <li>
                                                        <a data-toggle="tooltip" data-placement="top" title="Google" href="https://api.addthis.com/oexchange/0.8/forward/google_plusone_share/offer?url=http://apps.utpl.edu.ec/bancoideas&pubid=ra-56b133c326f46762&ct=1&title=Banco de Ideas: ${idea.nombre}" target="_blank">
                                                            <span class="fa-stack fa-lg">
                                                                <i class="fa fa-circle fa-stack-2x"></i>
                                                    ...
                                                    <li>
                                                        <a data-toggle="tooltip" data-placement="top" title="QR" href="http://carbono.utpl.edu.ec:8080/dataqr/index.jsp?cadena=http://apps.utpl.edu.ec/bancoideas" target="_blank">
                                                            <span class="fa-stack fa-lg">
                                                                <i class="fa fa-circle fa-stack-2x"></i>
        ...
        <div class="modal fade" id="mdl_login" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!--<div align="center">-->
                        <form action="${pageContext.request.contextPath}/auth.htm" modelAttribute="login" method="POST">  
                            <div class="section-title">
                                <h3>Ingreso al sistema</h3>
                                <span class="glyphicon glyphicon-info-sign"></span>&nbsp;<strong>Use claves del correo institucional</strong>
                            </div>
                            <div class="textbox-wrap">
                                <div class="input-group">
                                    <span class="input-group-addon "><i class="glyphicon glyphicon-user"></i></span>
                                    <input type="text" id="username" name="username" required="required" class="form-control" placeholder="Username" autocomplete="true" autofocus="autofocus" />
                                </div>
                            </div>
                            <div class="textbox-wrap">
                                <div class="input-group">
                            ...
                            <div class="login-form-action clearfix">
                                <button type="submit" class="btn btn-primary pull-right">Ingresar &nbsp; <i class="glyphicon glyphicon-log-in"></i></button>
                            </div>
                        </form>
                        <!--</div>-->
                    </div>
...
//                                if ($('#busqueda').val().trim() != '') {
                                $('#span_esperar').show();
                                $('#span_total').show();
                                buscar(true, page, rows, 'results', false, tipo);
//                                }
                            }
...
//            }
            ...
            var rows = 12;
            var modal_activo = false;
            function buscar(issearch, page, rows, div, bytag, tipo) {
                $('#' + div).text('');
                var q = $('#busqueda').val().trim();
                var results = '';
                var url = '';
                var data = {cadena: q, tipo: tipo};
                ...
                $.each(results, function (i, item) {
                    construir_resultado(div, item, false, tipo);
                });
                //                if (results.length > 0) {
            ...
            function construir_resultado(div, item, modal, tipo) {
                var subfix = '';
...
//                    if (tipo == 'idea') {
//                        contenido += '<a href="#" target="_blank" onclick="obtenerDetalle(' + item.id + ');"> <img class="img-responsive center-block" src = "bancoideas/' + item.imagen + '" onerror="error(this)" style = "height: 100px;" /> </a>';
//                    } else {
                            '<a href="#" target="_blank" onclick="obtenerDetalle(' + item.id + ');"> <img class="img-responsive center-block" src = "' + item.imagen + '" onerror="error(this)" style = "height: 100px;" /> </a>' +
//                    }
                            '<h3 class="box-title" style="height:50px;">' + item['nombre'] + '</h3>' +
                            '<br><span class = "label label-default" style="height:25px;">' + item.kw + '</span>';
                    if (description > 140) {
                        contenido += '<div class = "box-body" style="height:75px;">' + description + '<a href="#" onclick="obtenerDetalle(' + item.id + ');"> ... ver más</a> </div>';
                    } else {
                        contenido += '<div class = "box-body" style="height:75px;">' + description + ' </div>';
                    }
                    contenido += '<small>' +
                            ...
                            '<div>';
                    if (tipo == 'idea') {
                        contenido += '<small><small>' +
                                '<ul class="list-inline" >' +
                                '<li>' +
                                '    <a data-toggle="tooltip" data-placement="top" title="Facebook" href="https://api.addthis.com/oexchange/0.8/forward/facebook/offer?url=http://apps.utpl.edu.ec/bancoideas&pubid=ra-56b133c326f46762&ct=1&title=Banco de Ideas: ' + item.nombre + '" target="_blank">' +
                                '        <span class="fa-stack fa-lg">' +
                                '            <i class="fa fa-circle fa-stack-2x"></i>' +
                                '            <i class="fa fa-facebook fa-stack-1x fa-inverse"></i>' +
                                '        </span>' +
                                ...
                                '</li>' +
                                '<li>' +
                                '    <a data-toggle="tooltip" data-placement="top" title="Twitter" href="https://api.addthis.com/oexchange/0.8/forward/twitter/offer?url=http://apps.utpl.edu.ec/bancoideas&ct=1&title=Banco de Ideas: ' + item.nombre + '" target="_blank">' +
                                '        <span class="fa-stack fa-lg">' +
                                '            <i class="fa fa-circle fa-stack-2x"></i>' +
                                '            <i class="fa fa-twitter fa-stack-1x fa-inverse"></i>' +
                                '        </span>' +
                                ...
                                '</li>' +
                                '<li>' +
                                '    <a data-toggle="tooltip" data-placement="top" title="LinkedIn" href="https://api.addthis.com/oexchange/0.8/forward/linkedin/offer?url=http://apps.utpl.edu.ec/bancoideas&pubid=ra-56b133c326f46762&ct=1&title=Banco de Ideas: ' + item.nombre + '" target="_blank">' +
                                '        <span class="fa-stack fa-lg">' +
                                '            <i class="fa fa-circle fa-stack-2x"></i>' +
                                '            <i class="fa fa-linkedin fa-stack-1x fa-inverse"></i>' +
                                '        </span>' +
                                ...
                                '</li>' +
                                '<li>' +
                                '    <a data-toggle="tooltip" data-placement="top" title="Google" href="https://api.addthis.com/oexchange/0.8/forward/google_plusone_share/offer?url=http://apps.utpl.edu.ec/bancoideas&pubid=ra-56b133c326f46762&ct=1&title=Banco de Ideas:' + item.nombre + '" target="_blank">' +
                                '        <span class="fa-stack fa-lg">' +
                                '            <i class="fa fa-circle fa-stack-2x"></i>' +
                                '            <i class="fa fa-google-plus fa-stack-1x fa-inverse"></i>' +
                                '        </span>' +
                                ...
                                '</li>' +
                                '<li>' +
                                '    <a data-toggle="tooltip" data-placement="top" title="QR" href="http://carbono.utpl.edu.ec:8080/dataqr/index.jsp?cadena=' + item.url + '" target="_blank">' +
                                '        <span class="fa-stack fa-lg">' +
                                '            <i class="fa fa-circle fa-stack-2x"></i>' +
                                '            <i class="fa fa-qrcode fa-stack-1x fa-inverse"></i>' +
                                '        </span>' +
                    ...
                    contenido += '</div>' +
                            ...
                            '</div>' +
                            '</div>';
                    $('#' + div).append(div_inicial + contenido);
                }, 500);
            }
