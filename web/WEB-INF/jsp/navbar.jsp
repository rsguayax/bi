...
<nav class="navbar navbar-default" style="background-color: #fff;border:none;margin-bottom: 0px;border-radius:0;">
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse" style="border-bottom-color: steelblue; border-bottom: 2px;">
            <ul class="nav navbar-nav navbar-left">
<!--                <li> <img src="${pageContext.request.contextPath}/recursos/img/bi-utpl.png" style="height: 75px;" /> </li>-->
                <li> <p style="font-size: 24px;">&nbsp;&nbsp;Banco de Ideas UTPL</p> </li>
            </ul>
            <ul class="nav navbar-nav navbar-right" style="padding: 5px 0px;">
                <li>
                    <span class="label label-info" style="border-radius: 25px;" title="Inicio"> <a href="/bancoideas"><span class="glyphicon glyphicon-home"></span></a> </span> &nbsp;&nbsp;
                </li>
                <c:if test="${empty nombre}">
                    <li>
                        ...
                        <span class="label label-default" style="border-radius: 25px;" title="Ingresar">
                            <a href="auth.htm">Ingresar</a> 
                        </span>
                    </li>
                </c:if>
                <c:if test="${!empty nombre}">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                            <c:forEach items="${m.items}" var="it">
                                                <li> <a href="${it.url}?us=${us}&conv=${conv}" > <span class="${it.icono}" aria-hidden="true"></span> ${it.nombre} </a> </li>
                                                </c:forEach>
                                        </ul>
                                    </div>
                                </c:forEach>
